 ...
 * 
 * $Id: class.tx_commerce_payment_prepayment.php 483 2007-01-09 17:42:40Z ingo $
 */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']["ext/commerce/payment/class.tx_commerce_payment_prepayment.php"])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']["ext/commerce/payment/class.tx_commerce_payment_prepayment.php"]);
}
