...
if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/commerce/hooks/class.tx_srfeuserregister_hooksHandler.php"]) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/commerce/hooks/class.tx_srfeuserregister_hooksHandler.php"]);
}
