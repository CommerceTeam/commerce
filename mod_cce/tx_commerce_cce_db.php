...
class SC_tx_commerce_cce_db {
	...
	protected function showCopyWizard($uidClip, $uidTarget, $command) {
		...
		if (is_array ($TYPO3_CONF_VARS['EXTCONF']['commerce/mod_cce/class.tx_commerce_cce_db.php']['copyWizardClass'])) {
			foreach ($TYPO3_CONF_VARS['EXTCONF']['commerce/mod_cce/class.tx_commerce_cce_db.php']['copyWizardClass'] as $classRef) {
