 ...
 */
class Tx_Commerce_ViewHelpers_Navigation_StatisticViewHelper extends t3lib_SCbase {
	/**
...
if (defined('TYPO3_MODE') && $GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/commerce/Classes/ViewHelpers/Navigation/StatisticViewHelper.php']) {
	/** @noinspection PhpIncludeInspection */
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/commerce/Classes/ViewHelpers/Navigation/StatisticViewHelper.php']);
}
