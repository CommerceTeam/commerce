...
/**
 * @class TYPO3.Components.OrderTree.DeletionDropZone
 *
 ...
 */
TYPO3.Components.OrderTree.PageTreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
	/**
...
//        this.iconNode = cs[2];
		...
		if (!TYPO3.Components.OrderTree.Configuration.disableIconLinkToContextmenu
			|| TYPO3.Components.OrderTree.Configuration.disableIconLinkToContextmenu === '0'
		) {
	...
	onTipChange : function(node, tip, title) {
		TYPO3.Components.OrderTree.PageTreeNodeUI.superclass.onTipChange.apply(this, arguments);
	...
	onOver: function() {
		if (!this.node.ownerTree.dontSetOverClass) {
			TYPO3.Components.OrderTree.PageTreeNodeUI.superclass.onOver.apply(this, arguments);
		}
	}
});

// XTYPE Registration
Ext.reg('TYPO3.Components.OrderTree.PageTreeNodeUI', TYPO3.Components.OrderTree.PageTreeNodeUI);
