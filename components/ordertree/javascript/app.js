...
TYPO3.Components.OrderTree.App = Ext.extend(Ext.Panel, {
	...
	initComponent: function() {
		TYPO3.Components.OrderTree.DataProvider.loadResources(function(response) {
			...
			if (TYPO3.Components.OrderTree.Configuration.indicator !== '') {
	...
	addIndicatorItems: function() {
		this.addIndicator({
			...
			html: TYPO3.Components.OrderTree.Configuration.indicator
		});
	},
...
TYPO3.ModuleMenu.App.registerNavigationComponent('commerce-ordertree', function() {
	TYPO3.Backend.NavigationContainer.OrderTree = new TYPO3.Components.OrderTree.App();
