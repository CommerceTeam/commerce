...
/**
 * @class TYPO3.Components.CategoryTree.DeletionDropZone
 *
 * Deletion Drop Zone
 *
 ...
 * @extends Ext.Panel
 */
TYPO3.Components.CategoryTree.DeletionDropZone = Ext.extend(Ext.Panel, {
	/**
	 * Border
	 *
	 * @type {Boolean}
	...
	initComponent: function() {
		this.html = '<p><span id="' + this.id + '-icon">' + TYPO3.Components.CategoryTree.Icons.TrashCan + '</span><span id="' + this.id + '-text">' +
			TYPO3.Components.CategoryTree.LLL.dropToRemove + '</span></p>';

		TYPO3.Components.CategoryTree.DeletionDropZone.superclass.initComponent.apply(this, arguments);
	},
	...
	setRecoverState: function(node, tree, succeeded) {
		...
		this.show();
		this.setHeight(50);
		this.updateIcon(TYPO3.Components.CategoryTree.Icons.TrashCanRestore);
		this.updateText(
			node.text + '<br />' +
			'<span class="' + this.id + '-restore">' +
				'<span class="' + this.id + '-restoreText">' +
				TYPO3.Components.CategoryTree.LLL.dropZoneElementRemoved +
				'</span>' +
			'</span>',
			false
		);
	...
	toOriginState: function(hide) {
		...
		this.setHeight(35);
		this.updateText(TYPO3.Components.CategoryTree.LLL.dropToRemove, false);
		this.updateIcon(TYPO3.Components.CategoryTree.Icons.TrashCan);
		this.app.doLayout();
	},
	...
	restoreNode: function(node, tree) {
		...
		this.setHeight(35);
		this.updateText(TYPO3.Components.CategoryTree.LLL.dropZoneElementRestored);
		this.app.doLayout();
...
// XTYPE Registration
Ext.reg('TYPO3.Components.CategoryTree.DeletionDropZone', TYPO3.Components.CategoryTree.DeletionDropZone);
