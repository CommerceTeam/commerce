 ...
 */
TYPO3.Components.CategoryTree.PageTreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
	/**
...
//        this.iconNode = cs[2];
		...
		if (!TYPO3.Components.CategoryTree.Configuration.disableIconLinkToContextmenu
			|| TYPO3.Components.CategoryTree.Configuration.disableIconLinkToContextmenu === '0'
		) {
	...
	onTipChange : function(node, tip, title) {
		TYPO3.Components.CategoryTree.PageTreeNodeUI.superclass.onTipChange.apply(this, arguments);
	...
	onOver: function() {
		if (!this.node.ownerTree.dontSetOverClass) {
			TYPO3.Components.CategoryTree.PageTreeNodeUI.superclass.onOver.apply(this, arguments);
		}
	}
});

// XTYPE Registration
Ext.reg('TYPO3.Components.CategoryTree.PageTreeNodeUI', TYPO3.Components.CategoryTree.PageTreeNodeUI);
