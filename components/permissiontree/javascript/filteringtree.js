...
/**
 * @class TYPO3.Components.PermissionTree.FilteringTree
 *
 * Filtering Tree
 *
 * @namespace TYPO3.Components.PermissionTree
 * @extends TYPO3.Components.PermissionTree.Tree
 */
TYPO3.Components.PermissionTree.FilteringTree = Ext.extend(TYPO3.Components.PermissionTree.Tree, {
	/**
	 * Search word
	 *
	 * @type {String}
...
// XTYPE Registration
Ext.reg('TYPO3.Components.PermissionTree.FilteringTree', TYPO3.Components.PermissionTree.FilteringTree);
