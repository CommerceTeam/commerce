...
/**
 * @class TYPO3.Components.PermissionTree.DeletionDropZone
 *
 ...
 */
TYPO3.Components.PermissionTree.PageTreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
	/**
...
//        this.iconNode = cs[2];
		...
		if (!TYPO3.Components.PermissionTree.Configuration.disableIconLinkToContextmenu
			|| TYPO3.Components.PermissionTree.Configuration.disableIconLinkToContextmenu === '0'
		) {
	...
	onTipChange : function(node, tip, title) {
		TYPO3.Components.PermissionTree.PageTreeNodeUI.superclass.onTipChange.apply(this, arguments);
	...
	onOver: function() {
		if (!this.node.ownerTree.dontSetOverClass) {
			TYPO3.Components.PermissionTree.PageTreeNodeUI.superclass.onOver.apply(this, arguments);
		}
	}
});

// XTYPE Registration
Ext.reg('TYPO3.Components.PermissionTree.PageTreeNodeUI', TYPO3.Components.PermissionTree.PageTreeNodeUI);
