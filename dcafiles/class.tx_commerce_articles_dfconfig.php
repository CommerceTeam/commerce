		...
		1 => array(
			...
			'modifications' => array(
				...
				array(
					...
					'field_config' => array(
						...
						1 => array(
							...
							'label' => 'LLL:EXT:commerce/Resources/Private/Language/locallang_db.xml:tx_commerce_articles.price_gross',
							'config' => array(
								'type' => 'input',
								'size' => '15',
						...
						2 => array(
							'name' => 'price_net_###uid###',
							'label' => 'LLL:EXT:commerce/Resources/Private/Language/locallang_db.xml:tx_commerce_articles.price_net',
							'config' => Array(
								'type' => 'input',
								'size' => '15',
								'eval' => 'double2,nospace',
						...
						7 => array(
							...
							'label' => 'LLL:EXT:commerce/Resources/Private/Language/locallang_db.xml:tx_commerce_articles.purchase_price',
							'config' => Array(
								'type' => 'input',
								'size' => '15',
								'eval' => 'double2,nospace',
				...
				array(
					...
					'label' => 'LLL:EXT:commerce/Resources/Private/Language/locallang_db.xml:tx_commerce_articles.price_scale_startamount',
					'config' => array(
						'type' => 'user',
				...
				array(
					...
					'label' => 'LLL:EXT:commerce/Resources/Private/Language/locallang_db.xml:tx_commerce_articles.price_scale_count',
					'config' => array(
						'type' => 'user',
				...
				array(
					...
					'label' => 'LLL:EXT:commerce/Resources/Private/Language/locallang_db.xml:tx_commerce_articles.price_scale_steps',
					'config' => array(
						'type' => 'user',
				...
				array(
					...
					'label' => 'LLL:EXT:commerce/Resources/Private/Language/locallang_db.xml:tx_commerce_articles.price_scale_fe_group',
					'config' => array(
						'type' => 'select',
						'items' => Array(
							Array('', 0),
		...
		2 => array(
			...
			'modifications' => array(
				array(
					...
					'config' => array(
						'text' => ',--div--;LLL:EXT:commerce/Resources/Private/Language/locallang_db.xml:tx_commerce_articles.prices,prices;;;;1-1-1',
					),
				),
			),
		),
