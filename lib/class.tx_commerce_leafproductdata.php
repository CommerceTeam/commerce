 ...
 * 
 * $Id: class.tx_commerce_leafproductdata.php 308 2006-07-26 22:23:51Z ingo $
 */
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce/lib/class.tx_commerce_leafproductdata.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/commerce/lib/class.tx_commerce_leafproductdata.php']);
}
?>