 ...
 * @subpackage tx_comm
 * 
 * $Id: class.tx_commerce_category_navframe.php 9398 2008-06-29 17:03:34Z ischmittis $
 */
unset($MCONF);
...
class tx_commerce_category_navframe {
	 ...
	 */
		...
		//Kommentar Erik: warum ist das hier? Wird nie ausgeführt!
		$selClass[] = array ('txcommerceCategory' => $GLOBALS['TYPO3_CONF_VARS']['EXTCONF'][COMMERCE_EXTkey]['leafClasses']['txcommerceCategory']);
		
		$this->browseTrees->initLeafClasses($selClass, 'class.tx_commerce_category_navframe_graytree.php');
